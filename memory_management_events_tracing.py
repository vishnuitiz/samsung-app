...
def insert_dummy_data_memory_management_events_tracing():
    try:
        ...
        (pid,tid,event_type,proces_name,total_memory_gb,available_memory_gb, used_memory_gb ,memory_percent_used ,total_swap_gb , total_swap_gb ,swap__percent_used,recorded_at)
